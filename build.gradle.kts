...
dependencies {
	...
	api("org.jetbrains.exposed:exposed-dao:0.30.2")
	api("org.jetbrains.exposed:exposed-core:0.30.2")
	api("org.jetbrains.exposed:exposed-jdbc:0.30.2")
	api("org.jetbrains.exposed:exposed-java-time:0.30.2")
